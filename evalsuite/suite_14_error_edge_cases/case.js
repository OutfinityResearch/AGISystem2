/**
 * Test Case: Error Handling & Edge Cases
 * Tests graceful error handling, UNKNOWN results for missing concepts, empty list handling, and boundary conditions. A robust system should handle these cases without crashing and return meaningful results.
 * Version: 3.0
 */
  ...
  queries: [
    {
      ...
      expected_dsl: `@q1 XyzzyUnknown123 IS_A animal`,
      expected_answer: {
    ...
    },
    {
      ...
      expected_dsl: `
        @facts NonExistent FACTS any
        @q2 $facts NONEMPTY any
      `,
      expected_answer: {
    ...
    },
    {
      ...
      expected_dsl: `
        @unknownFacts UnknownThing FACTS any
        @count $unknownFacts COUNT any
      `,
      expected_answer: {
    ...
    },
    {
      ...
      expected_dsl: `
        @emptyFacts NonExistent FACTS any
        @q5 $emptyFacts NONEMPTY any
      `,
      expected_answer: {
    ...
    },
    {
      ...
      expected_dsl: `
        @isAnimal Cat IS_A animal
        @isPlant Cat IS_A plant
        @q6 $isAnimal AND $isPlant
      `,
      expected_answer: {
    ...
    },
    {
      ...
      expected_dsl: `
        @isAnimal2 Cat IS_A animal
        @isPlant2 Cat IS_A plant
        @either $isAnimal2 OR $isPlant2
      `,
      expected_answer: {
    ...
    },
    {
      ...
      expected_dsl: `
        @empty1 Xyzzy1 FACTS any
        @empty2 Xyzzy2 FACTS any
        @merged MERGE_LISTS $empty1 $empty2
        @q8 $merged NONEMPTY any
      `,
      expected_answer: {
    ...
    },
    {
      ...
      expected_dsl: `
        @unknown UnknownX IS_A UnknownY
        @q9 $unknown NOT any
      `,
      expected_answer: {
    ...
    },
    {
      ...
      expected_dsl: `
        @emptyList NothingHere FACTS any
        @filtered FILTER $emptyList relation=IS_A
        @q10 $filtered NONEMPTY any
      `,
      expected_answer: {
    ...
    },
    {
      ...
      expected_dsl: `
        @pushEmpty name PUSH any=empty_layer
        @check Cat IS_A animal
        @popEmpty any POP any
      `,
      expected_answer: {
