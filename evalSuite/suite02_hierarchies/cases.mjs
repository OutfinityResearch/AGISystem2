...
export const steps = [
  ...
  // === QUERY: What is Poodle (all transitive) ===
  {
    ...
    expected_nl: 'Poodle is a toy. Proof: Poodle is a toy.. Poodle is a dog. Proof: isA Poodle Toy. isA Toy Dog. Poodle is a canine. Proof: isA Poodle Toy. isA Toy Dog. isA Dog Canine. Poodle is a carnivore. Proof: isA Poodle Toy. isA Toy Dog. isA Dog Canine. isA Canine Carnivore. Poodle is a mammal. Proof: isA Poodle Toy. isA Toy Dog. isA Dog Canine. isA Canine Carnivore. isA Carnivore Mammal. Poodle is a vertebrate. Proof: isA Poodle Toy. isA Toy Dog. isA Dog Canine. isA Canine Carnivore. isA Carnivore Mammal. isA Mammal Vertebrate. Poodle is an animal. Proof: isA Poodle Toy. isA Toy Dog. isA Dog Canine. isA Canine Carnivore. isA Carnivore Mammal. isA Mammal Vertebrate. isA Vertebrate Animal. Poodle is a livingthing. Proof: isA Poodle Toy. isA Toy Dog. isA Dog Canine. isA Canine Carnivore. isA Carnivore Mammal. isA Mammal Vertebrate. isA Vertebrate Animal. isA Animal LivingThing. Poodle is an entity. Proof: isA Poodle Toy. isA Toy Dog. isA Dog Canine. isA Canine Carnivore. isA Carnivore Mammal. isA Mammal Vertebrate. isA Vertebrate Animal. isA Animal LivingThing. isA LivingThing Entity.'
  },
