...
@fp_val freezing_point DIM_PAIR 0
@_ water SET_DIM @fp_val
@_ ice IS_A solid
@temp_gt_0 temperature DIM_GREATER 0
@_ ice TRANSFORMS_TO water WHEN @temp_gt_0
@_ steam IS_A gas
@temp_gt_100 temperature DIM_GREATER 100
@_ water TRANSFORMS_TO steam WHEN @temp_gt_100
...
- After load, `@q water IS_A liquid` returns TRUE_CERTAIN

### Test: Theory Composition

Setup:
```sys2dsl
@_ basic_physics LOAD any
@_ chemistry_extension PUSH any
@_ H2O IS_A molecule
@_ water COMPOSED_OF H2O
@atoms_val atoms DIM_PAIR 3
@_ H2O SET_DIM @atoms_val
@saved physics_chemistry SAVE any
```
...
@_ Patient_X HAS_SYMPTOM fever
@_ Patient_X HAS_SYMPTOM cough
...
```sys2dsl
@_ THEORY_LOAD name="basic_physics"
@_ matter HAS_STATE solid
@_ matter HAS_STATE liquid
@_ matter HAS_STATE gas
@_ ice IS_A matter
@_ water IS_A matter
@_ steam IS_A matter
...
@wb_val warm_blooded DIM_PAIR true
@_ mammal SET_DIM @wb_val
@_ dog IS_A mammal
@_ cat IS_A mammal
...
@v VALIDATE_SCRIPT """
  @_ whale IS_A mammal
  @lives_val lives_in DIM_PAIR water
  @_ whale SET_DIM @lives_val
"""
# Expected: consistent
